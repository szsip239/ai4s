...
export const CHANNEL_CONFIGS: Record<ChannelType, ChannelConfig> = {
  ...
  opencode_go: {
    ...
    defaultModels: ['glm-5.1', 'glm-5', 'kimi-k2.5', 'kimi-k2.6', 'deepseek-v4-pro', 'deepseek/deepseek-v4.1-flash', 'mimo-v2.5', 'mimo-v2.5-pro'],
    apiFormat: OPENAI_CHAT_COMPLETIONS,
    color: 'bg-indigo-100 text-indigo-800 border-indigo-200',
    icon: OpenCode,
  },
  ...
  cline: {
    ...
    defaultModels: [
      'cline-pass/deepseek/deepseek-v4.1-flash',
