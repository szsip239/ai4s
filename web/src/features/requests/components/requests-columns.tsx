...
// 2026-09-03 owner 反馈默认隐藏 reasoningEffort/readCache/writeCache 三列（大面积空态，列显隐菜单可手动开启）；
// writeCache 上游已默认隐藏，此处补 reasoningEffort/readCache 两列
export const DEFAULT_HIDDEN_COLUMN_IDS = ['status', 'source', 'apiFormat', 'clientIP', 'tokensPerSecond', 'writeCache', 'reasoningEffort', 'readCache'];
