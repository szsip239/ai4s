...
| `src/locales/zh-CN/base.json` / `src/locales/en/base.json` | 3 键改值 + `auth.brand.description` 行后各 +12 键 | `sidebar.team.name`、`initialization.description`、`auth.signIn.title` 改 Ai-4S-infra；新增 `ai4s.brand.*`（name/tagline/四支柱 name+desc/cardDescription，中英双语） | issue #58 更名 + 4S 说明文案 | 2026-08-18 |
