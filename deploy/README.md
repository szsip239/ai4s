...
| shim | 本地构建 `../shim`（python:3.12-slim，issue #48 起含 PyMuPDF/python-docx/openpyxl/python-pptx 文档解析依赖） | DLP 词表/PII 适配 + 飞书告警适配 `/feishu-alert`（issue #17）+ 统一配置 admin 平面 `/dlp-admin/*`（issue #31–#36） |
